...
class Clase_factura {
    ...
    function lista_una_retencion_id($id) {
        if ($this->con->Conectar() == true) {
            return pg_query("SELECT * FROM  erp_retencion r, erp_i_cliente c where r.cli_id=c.cli_id and r.ret_id=$id");
        }
    }
...
class PDF extends FPDF {
    ...
    function factura($rst, $cns, $emisor, $amb) {

        // ///////////////////////////////// ENCABEZADO IZQUIERDO ///////////////////////////////////////////////////////
        $this->Ln($x + 2, $y + 90);
//        $this->Image('../img/logo_noperti.jpg', 5, 8, 100);
        ...
        $this->Ln($x + 4, $y + 1);
        $this->SetFont('helvetica', 'B', 8);
        $this->Cell(140, 5, "Razon Social / Nombres y Apellidos : " . utf8_decode(trim($rst[ret_nombre])), 'LT', 0, 'L');
        $this->Cell(55, 5, "Identificacion : " . utf8_decode($rst[ret_identificacion]), 'RT', 'R');
        $this->Ln();
        ...
        $this->Ln();
        $this->SetFont('helvetica', 'B', 8);
        $this->Cell(85, 9, "Direccion : " . utf8_decode($rst[ret_direccion]), 'LR');
        $this->Ln();
        $this->SetFont('helvetica', 'B', 8);
