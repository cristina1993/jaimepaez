            ...
            <table id="tbl_form"  >
                ...
                if ($fila == "0") {
                    ...
                    <tr>
                        ...
                        <td><input type ="text" size="10"  id="con_fecha_emision1"  value="<?php echo $rst['con_fecha_emision'] ?>" lang="1" onkeyup="this.value = this.value.replace(/[^0-9-]/, '')" maxlength="10" onchange="date_validator(this)"/></td>
                        <td>
