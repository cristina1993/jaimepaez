        ...
        <script>
            ...
            function save(id) {
                if (orc_factura.value == 0 && orc_factura.readOnly == false) {
                    ...
                    function (dt) {
                        if (dt == 0) {
                            window.location = "Form_i_orden_compra.php?orc_codigo=" + orc_codigo.value + "&y=" + aux_y.value;
                        } else {
                            alert(dt);
                        }
                    });
            ...
            <tbody class="tbl_frm_aux" >                 
                ...
                while ($rst = pg_fetch_array($cns)) {
                    ...
                    <tr>
                        ...
                        <td align="right"><?php echo number_format($rst[orc_det_vu], 1) ?></td>
                        <td align="right" class="sbtls" ><?php echo number_format($rst[orc_det_vt], 1) ?></td>
                        <td align="center">
                            <?php
                            if ($Prt->delete == 0) {
                                ?>
                                <img class="auxBtn" width="16px" src="../img/del_reg.png" onclick="del(<?php echo $rst[orc_det_id] ?>)">
                            <?php }
                            ?>
                        </td>
                    </tr>
                ...
                <tr>
                    ...
                    <td class="sbtls" align="right"><input type="text" size="10" readonly  value="<?php echo number_format($stb, 2) ?>" /></td>
                    <td></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class="sbtls" align="right"><input type="text" size="10" readonly  value="<?php echo number_format($iva12, 2) ?>" /></td>
                    <td></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class="sbtls" align="right" style="border-bottom:solid 1px #ccc;font-size:18px; "><input type="text" size="10" readonly  value="<?php echo number_format($total, 2) ?>" /></td>
                    <td></td>
                </tr>
                <?php
                if ($y == 0) {
