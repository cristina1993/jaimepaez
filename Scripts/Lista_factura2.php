    ...
    <head>
        ...
        <script>
            ...
            function auxWindow(a, id, x, comid) {
                ...
                {
                    case 0://Nuevo
                        frm.src = '../Scripts/Form_factura2.php?emisor=' + emisor.value + '&txt=' + t + '&desde=' + d + '&hasta=' + h;//Cambiar Form_productos
                        //look_menu();
                        parent.document.getElementById('contenedor2').rows = "*,80%";
                        break;
                    case 1://Editar
                        parent.document.getElementById('contenedor2').rows = "*,80%";
                        frm.src = '../Scripts/Form_factura2.php?id=' + id + '&x=' + x + '&emisor=' + emisor.value + '&txt=' + t + '&desde=' + d + '&hasta=' + h;//Cambiar Form_productos
                        break;
                    case 2://Eliminar
...
//                                        window.history.go(0);
                    ...
                    case 4://PDF
                        ...
                        frm.src = '../Scripts/frm_pdf_factura2.php?id=' + id;
                        break;
                    case 5:
...
//                            timeout: 6000,
                    ...
                    case 10://PDF
                        parent.document.getElementById('contenedor2').rows = "*,70%";
                        frm.src = '../Scripts/frm_pdf_factura1.php?id=' + id;
                        break;
                ...
                if (usuid == 1 || usuid == 109 || usuid == 57) {
                    ...
                    $.ajax({
                        ...
                        success: function (dt) {
                            ...
                            if (dt == 0) {
                                parent.document.getElementById('mainFrame').src = '../Scripts/Lista_factura2.php?txt=' + '' + '&desde=' + fec1 + '&hasta=' + fec2;
                            } else if (dt == 1) {
                ...
                while ($rst = pg_fetch_array($cns)) {
                    ...
                    <tr>
                        ...
                        <td style="width:170px">
                            <?php
                            if ($_SESSION[usuid] == 1 && empty($rst_ret) && empty($rst_nc) && empty($rst_nd) && $cta_v != 1 && $rst[fac_estado_aut]!='ANULADO') {
                                ?>
                            ...
                            <img class="auxBtn" width="12px" src="../img/orden1.png" onclick="auxWindow(10, '<?php echo $rst[fac_id] ?>')">
                    </tr>  
                    <?php
                }
                ?>
