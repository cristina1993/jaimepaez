    ...
    <head>
        <script>
            ...
            function aprobacion(a, id) {
                ...
                if (r == true) {
                    $.post("actions.php", {act: 50, id: id, sts: a}, function (dt) {
                        if (dt == 0)
                        {
                            window.history.go(0);
                        } else {
        ...
        <table style="" id="tbl" width='50%'>
            <caption class="tbl_head" >
                <center class="cont_menu" >
                    <?php
                    $cns_sbm = $User->list_primer_opl(88, $_SESSION[usuid]);
                    ...
                    <tr>
                        ...
                        <td align="center" >
                            ...
                            if ($Prt->edition == 0 && $rst[orc_estado] == 1) {
                                ?>
                                <img class="auxBtn" width="22px" src="../img/error.png" title="Rechazar" onclick="aprobacion(6,<?php echo $rst[orc_id] ?>)" />                                    
                                <img class="auxBtn" width="22px" src="../img/exito.png" title="Aprobar"  onclick="aprobacion(2,<?php echo $rst[orc_id] ?>)" />
                            <?php }
                            ?>
                        </td>
                    </tr>  
