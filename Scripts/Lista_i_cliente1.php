    ...
    <head>
        <script>
            ...
            function load_file() {
                ...
                $.ajax({
                    type: "POST",
                    url: "actions_upload_clientes.php",
                    data: formData,
                    contentType: false,
                    processData: false,
                    success: function (dt) {
        ...
        <tbody id="tbody">
            ...
            while ($rst = pg_fetch_array($cns)) {
                ...
                <tr class="fila">
                    ...
                    <td <?php echo $ev ?> ><?php echo strtolower($rst['cli_email']) ?></td>
                    <td <?php echo $ev ?> ><?php echo $rst['cli_estado'] ?></td>
                    <td align="center">
                        <?php
                        if ($Prt->delete == 0) {
                            ?>
                        <img src="../img/del_reg.png" width="16px"  class="auxBtn" onclick="del(<?php echo $rst[cli_id] ?>, 1)">
                            <?php
                        }
                        if ($Prt->edition == 0) {
                            ?>
