            ...
            while ($rst = pg_fetch_array($cns)) {
                ...
                <tr>
                    ...
                    <td align="center">
                        ...
                        if ($Prt->delete == 0) {
                            ?>
                            <img src="../img/del_reg.png" class="auxBtn" width="16px" onclick="del(<?php echo $rst[mpt_id] ?>)">

                            <?php
                        }
                        if ($Prt->edition == 0) {
                            ?>
                            <img src="../img/upd.png" class="auxBtn" width="16px" onclick="auxWindow(1,<?php echo $rst[mpt_id] ?>, 0)">
                        <?php }
                        ?>
                    </td>
                </tr>  
