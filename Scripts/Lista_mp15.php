...
$r_tip = pg_fetch_array($Set->lista_un_mp_mod(strtoupper($rst_ti[mod_descripcion])));
$tipo = $r_tip[ids];
            ...
            while ($rst = pg_fetch_array($cns)) {
                ...
                <tr>
                    ...
                    <td align="center">
                        ...
                        if ($Prt->delete == 0) {
                            ?>
                            <img src="../img/b_delete.png" onclick="del(<?php echo $rst[id] ?>, '<?php echo $tbl ?>', '<?php echo $rst[$tp0 . 'a'] ?>', '<?php echo $rst[mp_c] ?>')">
                        <?php }
                        ?>
                    </td>
                </tr>
