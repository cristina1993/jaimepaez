...
if (isset($_GET[search])) {
    ...
    $cns_data = $Rep->lista_reporte_ventas_productos_buscador($txt);
} else {
    $hasta = date('Y-m-d');
}
?>
...
<html> 
    ...
    <body>
        ...
        <table  id="tbl" style="width:100%">
            ...
            <thead>
                <tr>
                    <th width='150px' colspan="2">Productos</th>
                    <th></th>
                    <?php
            ...
            <script>
                ...
                $('.row').each(function () {
                    ...
                    while (j < l) {
                        j++;
                        cnt = '.cnt' + j;
                        t1 = $(this).find(cnt).html().replace(/,/g, '');
                        t_v = t_v + (t1 * 1);
                    }
                    $(this).append("<td align='right' name='cn" + this.lang + "' class='cnt' >" + accounting.formatMoney(t_v, "", dc, ",", ".")+ "</td><td align='right' name='vl" + this.lang + "' class='vlr' >" + accounting.formatMoney(pr * t_v, "", dec, ",", ".") + "</td>");
                });
            </script>
            <script>
                ...
                $('.locales').each(function () {
                    ...
                    $('#t_cnt' + this.lang).html(accounting.formatMoney(tcnt, "", dc, ",", "."));
//                    $('#t_cnt' + this.lang).html(tcnt.toFixed(dec));
                ...
                $('#t_vlr' + this.lang).html(accounting.formatMoney(tvlr, "", dec, ",", "."));
//                    $('#t_vlr' + this.lang).html(tvlr.toFixed(dec));
                });
