...
<html> 
    ...
    <body>
        <table border="0" align="left" style="border:solid 1px #009acd">
            <tr><td align="center" colspan="30" style="padding: 5 5 5 5;background-color:#11658d;color:white;font-size:11px  ">Formulario de Configuracion </td></tr>
            <tbody>
                <tr>
                    <?php
                    $row = 0;
                    ...
                    while ($n < count($data)) {
                        ...
                        <td>
                            <table class="submenu" id="<?php echo 'tbl_' . $n ?>" cellpadding="2"  >
                                <thead>
                                <th align="center" colspan="2" style="background:#11658d;color:white  " >PROPIEDADES <button style="position:absolute;top:0px; right:0px;cursor:pointer" onclick="cerrar('<?php echo 'tbl_' . $n ?>')">&#X00d7;</button></th>
                                </thead>
                                <tr>
                                    <td>Posicion</td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select title="Tabla de Enlace" class="<?php echo "clase" ?>" id="<?php echo 'et_' . $n ?>"  onchange="validaCampos(this.id)" >
                                            ...
                                            <option value="erp_tipos">Maquinas</option>
                                        </select>    
                                    </td>
                                </tr>
                                <tr>
                ...
                <script>
                    ...
                    document.getElementById(s).value = '<?php if (empty($value[1])) {
                            echo 0;
                        } else {
                            echo $value[1];
                        } ?>';
                    ...
                    document.getElementById(o).value = '<?php if (empty($value[4])) {
                            echo 0;
                        } else {
                            echo $value[4];
                        } ?>';
